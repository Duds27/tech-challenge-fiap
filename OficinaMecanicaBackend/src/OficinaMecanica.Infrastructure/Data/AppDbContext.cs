...
public class AppDbContext : DbContext
{
    ...
    public DbSet<NotificacaoOutbox> NotificacoesOutbox => Set<NotificacaoOutbox>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NotificacaoOutbox>(e =>
        {
            e.ToTable("NotificacoesOutbox");
            e.Property(n => n.NumeroOS).HasMaxLength(50).IsRequired();
            e.Property(n => n.DestinatarioEmail).HasMaxLength(150);
            e.Property(n => n.Assunto).HasMaxLength(200).IsRequired();
            e.Property(n => n.Corpo).IsRequired();
            e.Property(n => n.StatusAnterior).HasConversion<int>();
            e.Property(n => n.StatusNovo).HasConversion<int>();
            e.HasIndex(n => n.OrdemServicoId).HasDatabaseName("IX_Notificacao_OrdemServico");
        });
    }
}
